...
static void can_processEncoder(volatile Encoder_canStruct *cm, const CANRxFrame *const rxmsg) {
...
void can_processInit(void) {
     ...
     */
    chThdCreateStatic(can_rx1_wa, sizeof(can_rx1_wa), NORMALPRIO + 7, can_rx, (void *) &CAND1);
}
